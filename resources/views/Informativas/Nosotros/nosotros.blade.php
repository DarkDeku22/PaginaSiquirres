    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5">
          ...
          <style>
            .member-img img {
    width: 100%; /* Ajusta el ancho de la imagen para que ocupe todo el espacio disponible */
    height: 250px; /* Fija una altura para que todas tengan el mismo tamaño */
    object-fit: cover; /* Esto asegura que la imagen se recorte correctamente para no distorsionarse */
    border-radius: 50%; /* Esto hace que las imágenes sean circulares */
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img" style="">
              <img src="{{ $adminis->imagen }}" class="img-fluid" alt="">
              
            </div>
            <div class="member-info text-center">
              <h4>{{ $adminis->nombre }}</h4>
              <span>{{ $adminis->puesto }}</span>
              <p>{{ $adminis->descripcion }}</p>
            </div>
