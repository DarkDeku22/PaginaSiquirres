                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-6 text-center">
                                    ...
                                    <a data-aos="fade-up" data-aos-delay="200" href="{{ route($item->url) }}"
                        ...
                        <div class="col-lg-6 aos-init-animate" data-aos="fade-up" data-aos-delay="100">
                            <div class="card-item">
                                ...
                                <div class="card-body">
                                    ...
                                    <button class="boton" style="width: 119px; height: 33px;"><a
                                            href="{{ $item->url }}">Ver más <i
                    ...
                    @foreach ($conf as $item)
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="service-item  position-relative">
                                ...
                                <p>{!! $data !!}...</p>
                                <br>
                                <button class="boton"><a style="margin-top: 0px;" href={{ route('proyectos') }}
                                        class="readmore stretched-link">Ver más <i
                                            class="bi bi-arrow-right"></i></a></button>
                            </div>
