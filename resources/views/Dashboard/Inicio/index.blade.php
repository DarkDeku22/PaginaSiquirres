...
@section('index')
    ...
    @endif
       ...
       <main id="main" class="main">
            ...
            <div class="col-12">
                ...
                <nav>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalVistaPrevia">
                        ...
                        @include('Dashboard/Inicio/Modales/registerSlide')
                    </div>
                                                    ...
                                                    <div class="ps-3">
                                                        <h5>
                                                            <a class="colorTitulos" data-bs-toggle="modal"
                                                                ...
                                                                title="Editar Slide" href="">{{ $item->titulo }}</a>
                                                        </h5>
                                                        ...
                                                        <div class="px-2 py-2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 col-md-12">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $item->titulo }}"
                                                                            placeholder="Escriba el titulo" maxlength="50"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="btnTitulo" value="{{ $item->boton }}"
                                                                            placeholder="Titulo del botón" maxlength="50"
                                                                            required>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-6 col-md-12">
                                                                    ...
                                                                    <div class="">
                                                                        <label for="nueva_img" class="form-label">Insertar
                                                                            imagen:</label>
                                                                        <input
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('eliminarSlider',$item->id_slader) }}" method="POST">
                                                        @method('delete')
                                                        @csrf
                        ...
                        <div class="carousel-inner">
                            @foreach ($data as $index => $item)
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}"
                                    style="background-image: url({{ $item->img }}); height:400px; background-size:cover; background-position:center;">

                                    <div class="info d-flex align-items-center" style="height:100%;">
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <div class="col-lg-6 text-center">
                                                    <h2 data-aos="fade-down" style="color:#fff;">{{ $item->titulo }}</h2>
                                                    <p data-aos="fade-up" style="color:#fff;">{!! $item->subtitulo !!}</p>
                                                    <a data-aos="fade-up" style="color:#fff;" data-aos-delay="200"
                                                        href="{{ route($item->url) }}"
                                                        class="btn-get-started">{{ $item->boton }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <input
                                                                    class="form-control colorImput form-control2 input-imagen"
                                                                    type="file" name="nueva_imagen" accept="image/*"
                                                                    id="editarSlideInput" maxlength="250" required>
                                                            </div>
                                                            <div class="col-auto">
                                                                <button type="submit"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-12">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <input type="text" class="form-control colorImput"
                                                                        name="titulo" value=""
                                                                        placeholder="Escriba el título" maxlength="70"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <input type="text" class="form-control colorImput"
                                                                        name="url" value="" maxlength="300"
                                                                        placeholder="Escriba la URL del sitio" required>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-6 col-md-12">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control colorImput" name="titulo"
                                                                            value="{{ $ite->titulo1 }}"
                                                                            placeholder="Escriba el titulo" maxlength="70"
                                                                            required>
                                                                    </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalVistaPrevia" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control colorImput" name="titulo"
                                                value="" placeholder="Escriba el título" maxlength="50" required>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="form-control colorImput" name="btnTitulo"
                                                value="" placeholder="Titulo del botón" maxlength="50" required>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="">
                                            <label for="nuevoInput" class="form-label">Insertar
                                                imagen:</label>
                                            <input type="file"
                                                class="form-control input-imagen colorImput form-control2" id="nuevoInput"
                                                name="img" accept="image/*" maxlength="100" required>
                                            <div class="text-center">
