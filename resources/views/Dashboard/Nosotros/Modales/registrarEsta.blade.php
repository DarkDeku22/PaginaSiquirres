...
<div class="modal fade" id="registrarEsta" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered"> {{-- modal pequeño y centrado --}}
    <div class="modal-content">

      <div class="modal-header">
        <h5 class="modal-title colorTitulos">Registrar Estadística</h5>
      ...
      <form action="{{route('crearEsta')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control colorImput" id="nombreA" name="titulo1" maxlength="70" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control colorImput" id="puestoA" name="descripcion" maxlength="70" required>
          </div>
